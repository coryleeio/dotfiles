...
(use-package general
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "O i" '((lambda () (interactive)
              (find-file "~/Workspace/coryleeio/scratch/5-tasks/inbox.md"))
            :wk "Open inbox")
...
(use-package toc-org
    ...
    (setq org-default-notes-file "~/Workspace/coryleeio/scratch/5-tasks/inbox.md")

    (setq org-capture-templates
     '(
         ("t" "Task" entry (file "~/Workspace/coryleeio/scratch/5-tasks/inbox.md") 
            "* TODO %?\n")
      )
     )

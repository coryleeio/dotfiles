-- Needs auto complete from here for blink-cmp:
...
return {
  ...
  },
  {
    ...
    opts = {
      ...
      provider = "openai",
      openai = {
        --endpoint = "https://llm-proxy.sandbox.indeed.net/openai/v1",
        --model = "gpt-4o", -- your desired model (or use gpt-4o, etc.)
        endpoint = "https://llm-proxy.sandbox.indeed.net/bedrock/v1",

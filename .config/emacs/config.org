...
(use-package general
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "r F e" '(my/org-roam-find-endeavor :wk "Roam find endeavor")
...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(
     ...
     ("b" "Book reference" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/reference.org")
      ...
      :unnarrowed t)
     ("t" "Tech reference" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/reference.org")
      :if-new (file+head "references/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Reference:Tech")
      :unnarrowed t)
  ...
  (defun my/org-roam-find-endeavor ()
    (interactive)
    ;; Select a project file to open, creating it if necessary
    (org-roam-node-find nil nil
        (my/org-roam-filter-by-tag "Endeavor")))

...
(use-package general
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "r F w" '(my/org-roam-find-work :wk "Roam find work")
  ...
  (org-roam-capture-templates
   '(
     ...
     ("p" "Project" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/project.org")
      :if-new (file+head "projects/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Project:Zettel:Fleeting")
     ("w" "Work Project" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/project.org")

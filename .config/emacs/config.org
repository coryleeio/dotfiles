...
(use-package general
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "r j" '(:ignore t :wk "Roam Daily Journal Prefix")
    "r j d" '(org-roam-dailies-goto-date :wk "Roam Dailies by Date")
    "r j t" '(org-roam-dailies-goto-today :wk "Roam Dailies Today")
    "r j y" '(org-roam-dailies-goto-yesterday :wk "Roam Dailies Yesterday")
 ) 
...
(use-package toc-org
    ...
    (setq org-capture-templates
     '(("t" "Todo" entry (file "~/Workspace/coryleeio/Scratch/orgfiles/inbox.org") 
...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(("d" "default" plain
      ...
      :unnarrowed t)
     ("v" "video reference" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/video.org")
      :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Reference:Video")
      :unnarrowed t)
     ("b" "book reference" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/book.org")

...
(use-package general
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "r F p" '(my/org-roam-find-personal :wk "Roam find personal projects")
    "r F P" '(my/org-roam-find-work :wk "Roam find work projects")
 ) 
...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(
     ...
     ("r" "Find Reference Note" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/reference.org")
      :if-new (file+head "references/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Reference:Video")
      :unnarrowed t)

     ("p" "Find Personal Project Notes(personal tag)" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/project.org")
      :if-new (file+head "projects/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Project:Personal:Note"))

     ("P" "Find Work Project Notes(work tag)" plain (file "~/Workspace/coryleeio/Scratch/slipbox/templates/project.org")
      :if-new (file+head "projects/%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: :Project:Work:Note")
      :unnarrowed t)
    )
  )

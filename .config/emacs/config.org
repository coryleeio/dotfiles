...
- [[#language-support][LANGUAGE SUPPORT]]
  - [[#lsp-and-syntax-highlighting][LSP and Syntax highlighting]]
  - [[#linting][LINTING]]
...
(use-package dashboard
  ...
  (setq dashboard-startup-banner "~/.config/emacs/images/pylon.png")  ;; use custom image as banner
...
(use-package general
  ...
  (dt/leader-keys
    ...
    "TAB TAB" '(perspective-map :wk "Perspective") ;; Lists all the perspective keybindings
 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "o T" '(org-refile :wk "Org refile")
    "o T" '(org schedule :wk "Org schedule"))
...
* LANGUAGE SUPPORT
These modes configure syntax highlighting and lsp integration, you still need to have the language server installed for it to work.
...
(use-package toc-org
    ...
    (setq org-agenda-files (list 
        "~/Workspace/coryleeio/Scratch/orgfiles/refile.org"
    ...
    org-clock-sound "~/.config/emacs/alarm.wav"
    )
#+end_src

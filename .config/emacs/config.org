...
(use-package general
  ...
  (dt/leader-keys
    "b" '(:ignore t :wk "Bookmarks/Buffers/Registers")
    ...
    "b r" '(:ignore t :wk "Registers") 
    "b r c" '(copy-to-register :wk "Copy region into register")
    "b r i" '(insert-register :wk "Insert text from register")
    "b r v" '(view-register :wk "View text in register")
    "b r A" '(append-to-register :wk "Append region to register")
    "b r P" '(prepend-to-register :wk "Prepend region to register")
    "b r p" '(point-to-register :wk "Point saved to position in register")
    "b r j" '(jump-to-register :wk "Jump to position in register")
